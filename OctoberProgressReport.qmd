...
You can [see the progress we've made on these outlines here](https://agmath.github.io/IntroductoryBayesInContext/ContextFreeOverview.html). Aside from developing an outline for the new fourth activity, the only aspect of this goal we still need to complete is to formalize the Bayesian Thinking objectives associated with each activity.

#### Proof of Concept

We have constructed a working *proof of concept* that includes two versions of our first activity (*From the Prior to the Posterior*). We have two versions of this activity -- [one without context](https://agmath.github.io/IntroductoryBayesInContext/ContextFreeActivity1.html) and [another with a sample context from biology](https://agmath.github.io/IntroductoryBayesInContext/act1_bio_chytrid.html). 
