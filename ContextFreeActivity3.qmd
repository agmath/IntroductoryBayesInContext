...
### Autocorrelation
Looking at the autocorrelation more directly is another way to determine if the each chain is mimicing the behavior of an independent sample.  Due to the nature of sampling, some autocorrelation is to be expected.  However, it is expected to fade out.  In other words, we might expect chain 2 to be dependent on chain 1, and chain 3 to be dependent on chain 2, and slightly dependent on chain 1.  
