...
+ **Activity Series Vision and Outlines** -- We've created an [outline of our vision for this activity series](https://agmath.github.io/IntroductoryBayesInContext/ContextFreeOverview.html), along with activity objectives. 
+ **Activity I, *From the Prior to the Posterior*** -- We have completed our [context-free activity outline](https://agmath.github.io/IntroductoryBayesInContext/ContextFreeActivity1_v2.html) as well as a draft of a completed [version of this activity within a biology context](https://agmath.github.io/IntroductoryBayesInContext/act1_bio_chytrid_v2.html).
+ **Activity II, *Bayesian Boundaries: Investigating Credible Intervals*** -- We have completed a [context-free activity outline](https://agmath.github.io/IntroductoryBayesInContext/ContextFreeActivity2_v2.html) as well as a draft of a completed [version of this activity within a biology context](https://agmath.github.io/IntroductoryBayesInContext/act2_bio_chytrid_v2.html).
+ **Activity III, Bayesian Data Analysis*** -- We are working on this activity but are having difficulty running `Stan` from within the `{webr}` context. For now, here is [the current draft of the context-free version](https://agmath.github.io/IntroductoryBayesInContext/ContextFreeActivity3.html).
