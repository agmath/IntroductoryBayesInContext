...
There are many statistical tools which can be used to investigate population parameters. As we mentioned in [our first activity](https://agmath.github.io/Bayes-BATS-tier2/act1_bio_chytrid_v2.html), these tools fall into three broad categories:

+ Classical/Frequentist methods 
+ Simulation-based methods
+ Bayesian methods

This series of activities focuses on Bayesian methods. In this second activity, we engage in extracting and interpreting a *credible interval* from a *posterior* distribution. We’ll briefly review how to obtain the *posterior* distribution from the *prior* and observed data, but check back on [our first activity](https://agmath.github.io/Bayes-BATS-tier2/act1_bio_chytrid_v2.html) for full details.
...
In [Activity 1](https://agmath.github.io/Bayes-BATS-tier2/act1_bio_chytrid.html), we manually updated the prior, applying this relationship step-by-step via code, which provided transparency into the Bayesian updating process.
