...
There are many statistical tools which can be used to investigate population parameters. As we mentioned in [our first activity](https://agmath.github.io/Bayes-BATS-tier2/ContextFreeActivity1_v2.html), these tools fall into three broad categories:
...
In [Activity 1](https://agmath.github.io/Bayes-BATS-tier2/ContextFreeActivity1_v2.html), we manually updated the prior, applying this relationship step-by-step via code, which provided transparency into the Bayesian updating process.
