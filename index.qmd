...
+ Build a shareable draft proof of concept, including versions with and without discipline-specific context overlay, that can be used to discuss the project with potential in-discipline collaborators.
...
+ Draft context-free versions of at least the first two activities (*Prior to Posterior* and *Extracting and Interpreting Plausible Intervals*)
+ Identification of at least three collaborators across different domain disciplines
...
+ Drafts of the first activity in-context across at least three disciplines

  + Including discipline-specific objectives for the activity
  
+ Drafts of additional activities across our three (or more) identified partner disciplines

**December 2024:** By the end of December, we hope to have completed each of the following.

+ Finalized versions, ready to pilot, of at least two of the activities within each of our identified partner disciplines
